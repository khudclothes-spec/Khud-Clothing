...
Refinement pass over the order + payment + email flow, plus full SEO. **Run migrations in order after 001–026: [027_add_packed_status.sql](scripts/027_add_packed_status.sql)** (adds `packed`), **[028_defer_online_stock.sql](scripts/028_defer_online_stock.sql)** (deferred stock + `confirm_order_payment`), **[029_owner_order_notified.sql](scripts/029_owner_order_notified.sql)** (`owner_notified_at`).
