...
// Brand Open Graph image (white background, black خود wordmark, 1200×630).
// Served by the app/opengraph-image.png file convention. Pages that define
...
export const OG_IMAGE = {
  ...
  width: 1200,
  height: 630,
  alt: 'Khud — black Urdu "خود" wordmark on a white background'
};
