...
export const aboutBlocks = [
  {
    no: "01",
    title: "The name",
    body: "There are four of us, and every first name starts with M. Char meem, four Ms, was our name before we chose it. We kept it because it puts the people behind the clothes on the front of the brand."
  },
  {
    no: "02",
    title: "The idea",
    body: "Clothing is the most public thing you own. It should say something you chose, not something a warehouse chose for you. That idea sits under every piece we make."
  },
  {
    no: "03",
    title: "What we make",
    body: "Everyday staples finished properly: oversized tees, heavyweight hoodies, clean sweatshirts. Small, deliberate runs. If a design does not convince all four of us, it does not go to print."
  },
  {
    no: "04",
    title: "Make it yours",
    body: "The custom collection takes the idea to its end. Bring text or artwork, place it where you want it, approve the proof, and wear something that exists because you decided it should."
  }
];
